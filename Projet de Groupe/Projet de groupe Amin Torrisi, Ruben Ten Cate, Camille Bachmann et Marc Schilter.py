...
# ----------------Listes [statistiques]----------------
CARACTERISTIQUES = ["\033[91mForce\033[0m", "\033[34mDextérité\033[0m", "\033[92mConstitution\033[0m",
                    "\033[96mIntelligence\033[0m", "\033[95mSagesse\033[0m", "\033[94mCharisme\033[0m"]
...
class CharacterCreator:
    ...
    def run(self) -> Character:
        ...
        match methodes:
            ...
            case "Méthode fixe":
                print(
                    "Vous avez choisi la méthode fixe, veuillez a présent attribuer les scores définis aux 6 caractéristiques")
...
def main():
    creator = CharacterCreator(RACES, CLASSES, BACKGROUNDS,
                               WEAPON_GUERRIER + WEAPON_MAGICIEN + WEAPON_VOLEUR + WEAPON_CLERC, SHIELD, SCORES_FIXES,
                               METHODES_STAT, SKILLS)
